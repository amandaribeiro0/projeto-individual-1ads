...
function sobreSerie() {
    id_sobre.innerHTML = ` <h1>SOBRE A SÉRIE</h1>
    <p>"Blindspot" é uma série de televisão repleta de ação, mistério e reviravoltas que cativou audiências em todo
        ...
        <br>  <br>
        Temporada 1:
        A primeira temporada introduz Jane Doe, uma mulher misteriosa coberta de tatuagens que é encontrada em Times
        Square. Cada tatuagem contém pistas para crimes e conspirações que a equipe liderada por Kurt Weller começa
        a investigar. A temporada explora a busca pela identidade de Jane, sua ligação com uma organização criminosa
        chamada Sandstorm e os desafios de decifrar as tatuagens. A equipe enfrenta ameaças crescentes e segredos
        surpreendentes.
        <br>  <br>
        Temporada 2:
        Na segunda temporada, a equipe continua a desvendar os segredos por trás das tatuagens de Jane e a enfrentar
        ...
        <br>  <br>
        Temporada 3:
        A terceira temporada continua a saga de Jane e sua equipe, enquanto enfrentam conspirações, traições e lutas
        ...
        <br>  <br>
        Temporada 5:
        A quinta e última temporada concentra-se na batalha final contra o perigoso grupo terrorista Sandstorm e nas
    ...
    <iframe id="videoTrailer" width="460" height="215" src="https://www.youtube.com/embed/RqZkit-aCTo?si=S5JbUJTPvzBFOC5O"
...
function sobreSite() {
    ...
    <p>Este site dedicado à série "Blindspot" foi desenvolvido como parte do curso de Análise e Desenvolvimento de
